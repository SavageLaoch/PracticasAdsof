...
public class PruebaCine {
	public static void main(String[] args) {
		...
		/*Aqui da una excepcion que tenemos que mirar, creo que peta el equals de sala. Si pongo s1 si va.
		System.out.println(cine.venderEntrada(12, s2, 15, 0));*/
		System.out.println(cine.venderEntrada(12, s1, 15, 0));
		...
		/*Vuelve a petar el equals yo creo
		...
		*/
		...
		System.out.println("Borramos una sala del cine: ");
		System.out.println(cine.removeSala(3));
		System.out.println("Intentamos volver a borrar la misma sala: ");
		System.out.println(cine.removeSala(3));
		
		
		/*System.out.println("Borramos una pelicula del cine: ");
