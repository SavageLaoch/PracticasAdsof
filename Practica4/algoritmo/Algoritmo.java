...
public class Algoritmo implements IAlgoritmo {
	 ...
	 * 
	 * @param terminales
	 *            Conjunto de terminales a definir
	 */
	@Override
	 ...
	 * 
	 * @param funciones
	 *            Conjunto de funciones a definir
	 */
	@Override
	...
	/**
	 * Crea una poblacion desde 0 con profunidad 2 y 20 individuos(se puede
	 * modificar en esta funcion)
	 */
	@Override
	...
	/**
	 * Crea una nueva generacion para la poblacion. Selecciona un élite y un
	 * individuo aleatorio. Selecciona otros dos individuos para el cruce.
	 */
	@Override
	...
	/**
	 * Ejecuta el algoritmo sobre el dominio que se le pasa. Max gen = 100 Fitness
	 * min = 21
	 */
	@Override
