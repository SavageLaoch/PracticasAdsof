...
public abstract class Terminal extends Nodo {
	...
	/**
	 * Incluye un nodo en la lista de descendientes Esta funcion no se usara porque
	 * un terminal no tiene descendientes
	 * 
	 * @param INodo
	 *            nodo a incluir
	 */
	...
	/**
	 * Copia el nodo terminal. (Esta implementada en TerminalAritmetico)
	 */
